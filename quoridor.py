...
class Quoridor:
    ...
    def construire_graphe(self, joueurs, murs_horizontaux, murs_verticaux):
        ...
        """
        graphe = self.graphe_helper(murs_horizontaux, murs_verticaux)
    ...
    def graphe_helper(self, murs_horizontaux, murs_verticaux):
                ...
                for sens in ['horizontal', 'vertical']:
                    ...
                    for pos in [((c[0] - 1), c[1]),
                        ...
                        try:
                            ...
                            graphe = ''
                            if sens == 'horizontal':
                                graphe = self.construire_graphe([joueur['pos'] for
